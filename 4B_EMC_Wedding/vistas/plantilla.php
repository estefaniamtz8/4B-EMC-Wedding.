...
<header class="header-section">
   <div class="container">
      ...
      <?php if ( isset($_GET["pagina"] )): ?>
         ...
         <li class="active">
             <a href="index.php?pagina=index">index</a>
         </li>
         <?php else: ?>
            <li>
               <a href="index.php?pagina=index">index</a>
         ...
         <?php else: ?>
            <li>
               <a href="about.php?pagina=about">About</a>
            </li>
         <?php endif ?>

         <?php if ($_GET["pagina"]=="blog-single"): ?>
         <li class="active">
             <a href="index.php?pagina=blog-single">blog-single</a>
         </li>
         <?php else: ?>
            <li>
               <a href="about.php?pagina=blog-single">blog-single</a>
            </li>
         <?php endif ?>
         ...
         <?php else: ?>
            <li>
               <a href="about.php?pagina=blog">blog</a>
            </li>
         <?php endif ?>
         ...
         <?php else: ?>
            <li>
               <a href="about.php?pagina=contact">contact</a>
            </li>
         <?php endif ?>
         ...
         <li class="active">
             <a href="index.php?pagina=event">event</a>
         </li>
         <?php else: ?>
            <li>
               <a href="about.php?pagina=event">event</a>
            </li>
         <?php endif ?>

         <?php if ($_GET["pagina"]=="gallaery"): ?>
         <li class="active">
             <a href="index.php?pagina=gallery">gallery</a>
         </li>
         <?php else: ?>
            <li>
               <a href="about.php?pagina=gallery">About</a>
            </li>
         <?php endif ?>
         ...
         <?php else: ?>
            <li>
               <a href="about.php?pagina=service-single">service-single</a>
            </li>
         <?php endif ?>
         ...
         <?php else: ?>
            <li>
               <a href="about.php?pagina=service">service</a>
            </li>
         <?php endif ?>
         ...
         <?php else: ?>
            <li>
               <a href="about.php?pagina=story">story</a>
            </li>
         <?php endif ?>
         ...
         <?php else: ?>
            <li>
               <a href="about.php?pagina=registro">registro</a>
            </li>
         <?php endif ?>
         ...
         <?php else: ?>
            ...
            <li>
               ...
               <ul class="sub-menu">
                  <li class="subtwohober">
                     <a href="service.php?pagina=service">
                        <span>Service</span>
                     </a>
                  </li>
                  <li class="subtwohober">
                     <a href="service-single.php?pagina=service-single">
            ...
            <li>
               ...
               <ul class="sub-menu">
                  ...
                  <li class="subtwohober">
                     <a href="gallery.php?pagina=gallery">
                        <span>Gallery</span>
                     </a>
                  </li>
                  <li class="subtwohober">
            ...
            <li>
               ...
               <ul class="sub-menu">
                  <li class="subtwohober">
                     <a href="blog.php?pagina=blog">
                        <span>Blog</span>
                     </a>
                  </li>
                  <li class="subtwohober">
                     <a href="blog-single.php?pagina=blog-single">
            ...
            <li>
               <a href="contact.php?pagina=contact">Contact</a>
            </li>
      <?php endif ?>
          ...
          <div class="row g-4 justify-content-center">
             <div class="col-lg-12">
                <div class="banner__content center">
                   ...
                   <h1 class="wow fadeInDown" data-wow-duration="4s">Estefania & Habid</h1>
...
<!-- ACÁ ESTA LO DEL INCLUDE PHP    -->
      
<?php

#LISTA DE PAGINAS BLANCAS
